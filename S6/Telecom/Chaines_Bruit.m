...
%     %Diagramme de l'oeil chaine 1 avec bruit
     diagramme_oeil_1 = reshape(Signal_z1,Nsbin,floor(length(Signal_z1)/Nsbin)) ; 
     figure(10+i);
     plot(diagramme_oeil_1);
     xlabel("Temps(s)");
     ylabel("Amplitude");
...
for i=1:N
    ...
    Signal_z2 = filter(hr2,1,Signal_Filtre2 + bruit2);
     ...
     diagramme_oeil_2 = reshape(Signal_z2,Nsbin,floor(length(Signal_z2)/Nsbin)) ; 
     figure(20 + i);
     plot(diagramme_oeil_2);
     xlabel("Temps(s)");
     ylabel("Amplitude");
