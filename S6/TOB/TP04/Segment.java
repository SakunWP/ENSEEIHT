...
public class Segment {
	...
	*/
	...
	public void dessinerSVG(AfficheurSVG svg){
		svg.dessinerLigne(this.extremite1.getX(),this.extremite1.getY(),this.extremite2.getX(),this.extremite2.getY(),this.couleur);
	}
