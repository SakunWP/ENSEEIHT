...
public class PointDeVente {
	...
	public int getPrix(Carburant carburant, LocalDateTime date) {
		if (prix.containsKey(carburant)){
			NavigableMap<LocalDateTime, Integer> prixDate = (NavigableMap<LocalDateTime, Integer>) prix.get(carburant);
			Map.Entry<LocalDateTime, Integer> entry = prixDate.floorEntry(date);
			if (entry != null){
