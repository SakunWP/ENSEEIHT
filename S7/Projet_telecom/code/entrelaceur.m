...
for i = 1:length(EbN0_db)
    ...
    %retard introduit de nrows * slope * (nrows -1)
    ...
    retard = (6 * Ns); %retard causé par le filtre égale à la moitié de sa longeur, y en a deux
    modulation = [kron(symboles', [1, zeros(1, Ns-1)]) zeros(1,retard)];  %on ajoute des zero à la fin
