...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                       Égalisation ML (Maximum Likelihood)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Application de l'égalisation ML
symbolesEgales = conj(matr_ck) .* symbolesRecus;
...
figure('Name', 'Constellation porteuse 6 après égalisation ML');
scatter(real(porteuse6), imag(porteuse6));
xlabel('Partie réelle');
ylabel('Partie imaginaire');
title('Constellation - Porteuse 6 (après égalisation ML)');
grid on;

figure('Name', 'Constellation porteuse 15 après égalisation ML');
scatter(real(porteuse15), imag(porteuse15));
xlabel('Partie réelle');
ylabel('Partie imaginaire');
title('Constellation - Porteuse 15 (après égalisation ML)');
grid on;
